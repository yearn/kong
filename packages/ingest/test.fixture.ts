...
export const addresses = {
  v2: {
    ...
    strategyLenderYieldOptimiser:
      '0xd8F414beB0aEb5784c5e5eBe32ca9fC182682Ff8' as `0x${string}`,
    ...
    genericLevCompFarmWeth:
      '0x83B6211379c26E0bA8d01b9EcD4eE1aE915630aa' as `0x${string}`,
    strategystEthAccumulator_v2:
      '0x120FA5738751b275aed7F7b46B98beB38679e093' as `0x${string}`,
  },
  ...
  v3: {
    ...
    yvusdca_debtManager:
      '0x62833b804624452F165272D183193f7D0Df97ab3' as `0x${string}`,
    usdc: '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174' as `0x${string}`,
    aaveV3UsdcLender:
      '0xdB92B89Ca415c0dab40Dc96E99Fc411C08F20780' as `0x${string}`,
    compoundV3UsdcLender:
      '0xb1403908F772E4374BB151F7C67E88761a0Eb4f1' as `0x${string}`,
    stargateUsdcStaker:
      '0x8BBa7AFd0f9B1b664C161EC31d812a8Ec15f7e1a' as `0x${string}`,
  },
