...
describe('things', function () {
  ...
  it('gets things >= apiVersion', async () => {
    ...
    expect(localThings.length).to.equal(2)
    expect(localThings[0].address).to.equal('0x3')
    expect(localThings[1].address).to.equal('0x4')
  })
  ...
  it('gets things > and <= apiVersion', async () => {
    ...
    expect(localThings.length).to.equal(2)
    expect(localThings[0]).to.deep.equal(things[1])
    expect(localThings[1]).to.deep.equal(things[2])
  })
  ...
  it('gets things by label', async () => {
    ...
    expect(localThings.length).to.equal(1)
    expect(localThings[0]).to.deep.equal(things[4])
  })
  ...
  it('gets things by ~label', async () => {
    ...
    expect(localThings.length).to.equal(4)
    expect(localThings).to.deep.equal(things.slice(0, 4))
  })
